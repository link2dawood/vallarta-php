<?php
include 'header.php';
?><title>All Sales Are Final - About 420 Puerto Vallarta - Cannabis Puerto Vallarta</title>
    ...
    <div class="col-md-7">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 ml-auto">
            ...
            <p>We love to make sure our clients are happy and are enjoying their stay here in Puerto Vallarta and Nuevo Vallarta and we are gracious in granting requests but All Sales Are Final with the exception of manufacture defect in vape cartridges and vape batteries. <br />
                  <br />
                  <a href="420 Vallarta vape and cartridge.php">Vape &amp; Cartrdige Exchange Policy</a> </p>
                <h3>&nbsp;</h3>
            <p align="center"><br />
            <a href="ClientServices.php">Client Services</a> || <a href="420vallarta staff.php">Staff </a>|| <a href="Be%20Thoughtful.php"> Be Thoughtful </a><br />
            <a href="Trust 420 Vallarta.php">Trust 420 Vallarta</a></p>
                <p>&nbsp;</p>
