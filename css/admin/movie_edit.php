...
if (isset($_POST['submit_edit_movie'])){
    ...
    $query = "UPDATE movies SET cat_id='$cat_id', group_id = '$group_id',title='$title',short_desc='$short_desc',long_desc='$long_desc',thumbnail='$thumbnail',video_type = '$video_types',video = '$video' WHERE id ='$id'";
...
<input name="id" value="<?= $id;?>" hidden>
    ...
    <button type="submit" name="submit_edit_movie" class="btn btn-primary float-right">Update Movie</button>
</form>