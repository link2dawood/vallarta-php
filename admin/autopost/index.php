...
//db model request
$q = "SELECT MAX(id) as id FROM movies";
$r = mysqli_fetch_assoc(mysqli_query($con,$q));
$id = $r['id'];
$q2 = "SELECT * FROM movies where id ='$id'";
$p = mysqli_fetch_assoc(mysqli_query($con,$q2));
$movieLink = 'https://movies.delux.icu/movie_detail.php?id='.$p['id'];
...
//tw
$status = 'Watch '.$p['title']. ' here: https://movies.delux.icu/movie_detail.php?id='.$p['id'];
  ...
  //echo $accessToken;
    ...
    if($response){
       ...
       //print_r($imageMediaObjectResponseArray);
        ...
        echo '<a href="https://movies.delux.icu/admin/movie_manager.php?page=data">go back to movie manager</a>';
        unlink($newFile);
    }
