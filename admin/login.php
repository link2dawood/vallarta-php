...
<head>
    ...
    <link href="twitter/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    if (isset($_GET['pesan'])) {
                                        if ($_GET['pesan'] == "error") {
                                            echo "<div class='alert alert-danger'>Login Error! Wrong username/password!</div>";
                                        } else if ($_GET['pesan'] == "logout") {
                                            echo "<div class='alert alert-success'>Logout Successfully</div>";
                                        } else if ($_GET['pesan'] == "no_session") {
                                            echo "<div class='alert alert-warning'>Access Restricted - Please Login</div>";
                                        } else if ($_GET['pesan'] == "invalid_user") {
                                            echo "<div class='alert alert-danger'>Invalid User Account</div>";
                                        } else if ($_GET['pesan'] == "access_denied") {
