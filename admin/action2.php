...
if ($act == 'editmovie') {
    ...
    $query = "UPDATE movies SET cat_id='$cat_id', region_id = '$region_id', group_id='$group_id',title='$title',short_desc='$short_desc',long_desc='$long_desc',thumbnail='$thumbnail',video_type = '$video_types',video = '$video', trailer='$trailer',ad_img='$ad_img', ad_link='$ad_link' WHERE movie_id ='$id'";
...
if ($act == 'add') {
    ...
    $query = $con->query("INSERT INTO movies (title,cat_id,short_desc,long_desc,thumbnail,video_type,video,group_id, region_id, trailer,ad_img,ad_link,added_by) VALUES ('$title','$cat_id','$short_desc','$long_desc','$thumbnail','$video_types','$video','$group_id','$region_id','$trailer','$ad_img','$ad_link','$added_by')");
    if($query){
